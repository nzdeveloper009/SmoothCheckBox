package com.nzdeveloper.smoothcheckboxlibrary
...
class SmoothCheckBox : View, Checkable {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(
            R.styleable.SmoothCheckBox_stroke_width, CompatUtils.dp2px(
                context, 0f
            )
        )
        ta.recycle()
    ...
    private fun measureSize(measureSpec: Int): Int {
        val defSize = CompatUtils.dp2px(
            context,
            DEF_DRAW_SIZE.toFloat()
        )
    ...
    private fun drawCenter(canvas: Canvas) {
        ...
        canvas.drawCircle(
            mCenterPoint!!.x.toFloat(), mCenterPoint!!.y.toFloat(), radius,
            mPaint!!
        )
    }
    ...
    private fun drawBorder(canvas: Canvas) {
        ...
        canvas.drawCircle(
            mCenterPoint!!.x.toFloat(), mCenterPoint!!.y.toFloat(), radius * mFloorScale,
            mFloorPaint!!
        )
    }
